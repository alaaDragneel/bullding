...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('users') }}">Site Messages</a></li>
      </ol>
    </section>
	  ...
	  <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Site Messages</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$('#myTableData tfoot th').each( function () {
 ...
 if($(this).index()  < 3 ){
	...
	$(this).html( '<select class="' + classname + '"><option value="0"> New Message </option><option value="1"> Seen </option></select>' );
